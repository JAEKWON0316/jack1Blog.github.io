...
const Carrer = () => {
  return (
    ...
    <h1 className='mb-5 black_font flex_underline'><i class="ri-links-line"></i><span className="block_underline">Career</span></h1>
      ...
      <div className='underline_box mb-4'>Django 풀 스택 기반의 작가 개인용 웹사이트를 node.js와 장고 레스트 기반으로 마이그레이션</div>
      ...
      <div className='underline2_box'>Django 풀 스택 기반의 작가 개인용 웹사이트를 node.js와 장고 레스트 기반으로 마이그레이션</div>
