  ...
  return (
    <section id="about">
      ...
      <h3 className='mb-5'>저는 웹 그리고 모바일 애플리케이션을 만드는중입니다.</h3>
          ...
          이 공부들은 그동안 배워왔던 무조건 외워서 하는 공부가 아닌 제가 이해를 하여 결과를 도출할 수 있다는 점이 매력적으로 다가왔고 스스로가 재미있어서 노력하게 되었습니다. 
          남들보다 뒤처졌다는 걸 안 저는 성장하기 위해 스스로 학습 및 학원을 다니며 공부해왔고 
          이러한 행동들은 제 도전정신에 대한 밑거름이 되어 졸업 후에 자격증 취득 및 여러 프로젝트 개발에 도움을 주었습니다.
