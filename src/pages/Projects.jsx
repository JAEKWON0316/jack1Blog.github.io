...
const Projects = () => {
  ...
  const [showReadme, setShowReadme] = useState(false); // README 상태 관리
  ...
  return (
    <section id="projects">
              ...
              <div className="project_card">
                ...
                <div className="text_box basic_font">
                  ...
                  <div className="project_btn mt-2">
                    ...
                    {index === 0 && (
                      <button className="p_btn_1" onClick={handleReadmeClick}>
      ...
      {/* README가 열리면 표시 */}
      {showReadme && <Readme onClose={closeReadme} />}
    </section>
  );
}
